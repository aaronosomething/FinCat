    ...
    >
      ...
      <Box sx={{ gridArea: "networth_chart" }}>
        <Paper elevation={3} sx={{ p: 2, boxSizing: "border-box", width: "100%" }}>
          ...
          <Box sx={{ mt: 0, pb: 1, textAlign: "center" }}>
            <Typography variant="h5">Your Estimated Net Worth is:</Typography>
            <Typography pt={1} variant='h4'>${Number(netWorth).toLocaleString(undefined, {
